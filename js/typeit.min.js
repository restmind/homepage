...
! function (n, t) {
	...
	var f = function (n) {
		...
		d = function n(t, e, r) {
			...
			return i = s(i), e && (i = i.filter((function (n) {
				return !n.parentNode.isEqualNode(e)
			}))), r ? i.reverse() : i
		},
		h = function (n) {
		...
		p = function (n, t) {
			...
			return {
				node: t,
				isTopLevelText: (!t || h(t.parentNode)) && !e,
				isHTMLElement: e,
				content: n
			}
		};
		...
		L = function (n, t, e, r) {
			...
			if (N(n)) n.value = "".concat(n.value).concat(t.content);
				...
				if (!t.isTopLevelText && !i) {
					...
					else if ((o = u.cloneNode()).innerText = t.content, !h(u.parentNode)) {
						for (var a = u.parentNode, f = a.cloneNode(), s = T(f, n); !s && !h(a);) f.innerHTML = o.outerHTML, o = f, f = a.parentNode.cloneNode(), a = a.parentNode, s = T(f, n);
						n = s || n
					}
				}
				var l = d(n, e, !0)[r - 1],
					p = l ? l.parentNode : n;
				p.insertBefore(o, p.contains(e) ? e : null)
			}
		},
		M = function (n) {
			var t;
	...
	function P(n, t, e) {
		if (!n.s) {
			if (e instanceof k) {
				if (!e.s) return void(e.o = P.bind(null, n, t));
				1 & t && (t = e.s), e = e.v
			}
			if (e && e.then) return void e.then(P.bind(null, n, t), P.bind(null, n, 2));
			n.s = t, n.v = e;
			var r = n.o;
			r && r(n)
		}
	...
	var k = function () {
		...
		return n.prototype.then = function (t, e) {
			...
			return this.o = function (n) {
				try {
					var i = n.v;
					1 & n.s ? P(r, 1, t ? t(i) : i) : e ? P(r, 1, e(i)) : P(r, 2, i)
				} catch (n) {
					P(r, 2, n)
				}
			}, r
	...
	return function (e, o) {
		...
		var h = function (n, t, e) {
			...
			I = D((function () {
				if (fn) {
					...
					return E(t || document.fonts.ready, (function (n) {
			...
			R = D((function (n, t) {
				return $.push(setTimeout(n, t)), E()
			})),
			j = D((function (n) {
				return A((function () {
					if (_) return C(F(_))
				}), (function () {
					an.reset().delete(0).add([U, n.before], !0), z().forEach((function (n) {
						an.add([G, null, {
							isPhantom: !0
						}], 1, !0)
					}))
					...
					return O(function (n, t, e) {
						...
						return function u(c) {
							try {
								for (; ++o < n.length && (!e || !e());)
									if ((c = t(o)) && c.then) {
										if (!((a = c) instanceof k && 1 & a.s)) return void c.then(u, i || (i = P.bind(null, r = new k, 2)));
										c = c.v
									}
								r ? P(r, 1, c) : r = c
							} catch (n) {
						...
						var r, i, o, c, a = t[e],
							f = a[2];
						return n = [a, u], f.freezeCursor && q(!0), r = en.speed, i = en.deleteSpeed, o = en.lifeLike, c = (i = null !== i ? i : r / 3) / 2, Z = o ? [S(r, r / 2), S(i, c)] : [r, i], A((function () {
							var t;
							if (null == f ? void 0 : f.isFirst) return C((t = en).beforeString.apply(t, n))
						}), (function () {
							var t;
							return E((t = en).beforeStep.apply(t, n), (function () {
								return E(a[0].call(u, a[1], f), (function () {
									return A((function () {
										if (!f || !f.isPhantom) return A((function () {
											var t, e;
											if (null === (t = a[2]) || void 0 === t ? void 0 : t.isLast) return C((e = en).afterString.apply(e, n))
										}), (function () {
											var t;
											return E((t = en).afterStep.apply(t, n), (function () {
												an.setMeta(f.id, {
													executed: !0
												})
											}))
						...
						var e;
						return tn.completed = !0, E((e = en).afterComplete.apply(e, n), (function () {
							if (en.loop) {
								var n = en.loopDelay;
								R((function () {
				...
				return t = !0 === t, new Promise((function (e) {
					R(D((function () {
						...
						return i.length && (X ? W.value = W.value.slice(0, -1) : M(i[_])), f(W.querySelectorAll("*")).forEach((function (n) {
							...
							if (t && i.length - 1 > 0) return E(n(!0), (function () {
								return r = !0, e()
							}))
						}), (function (n) {
							return r ? n : e()
		...
		this.break = function (n) {
			return h([K, p(m("BR"))], 1, n)
		}, this.delete = function (n, t) {
			var e = T(t);
			return h([e[0]].concat([].concat(Array(Math.abs(n) || 1)).fill().map((function () {
				return [G, !n, nn]
			})), [e[1]]), 1, t)
		}, this.empty = function () {
			return h(Y, 1, arguments)
			...
			return h([r[0]].concat([].concat(Array(Math.abs(n) || 1)).fill().map((function () {
				return [F, i, nn]
			})), [r[1]]), 1, t)
